 ...
 * Hostname must be a TLD! (will not match example@localhost)
 */
exports.COMMA_SEPARATED_EMAILS_REGEX_STR = `(${exports.EMAIL_REGEX_STR})( *, *${exports.EMAIL_REGEX_STR})*`;
/**
 * Matches a string containing single email or multiple emails separated by comma
 * Hostname must be a TLD! (will not match example@localhost)
 */
exports.COMMA_SEPARATED_EMAILS_REGEX = new RegExp(`^${exports.COMMA_SEPARATED_EMAILS_REGEX_STR}$`);
/**
